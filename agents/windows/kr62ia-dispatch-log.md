---
name: kr62ia-dispatch-log
description: 'Single-card dispatch: `kr62ia` — Windows Notification Template Resolution Engine'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: PeonPing/peon-ping
    ...
    path: .gitban/agents/dispatcher/inbox/kr62ia-dispatch-log.md
