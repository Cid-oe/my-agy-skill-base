...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''codebase'', ''edit/editFiles'', ''search'', ''runCommands'', ''runTasks'', ''runTests'', ''problems'', ''changes'', ''usages'', ''findTestFiles'', ''testFailure'', ''terminalLastCommand'', ''terminalSelection'', ''web/fetch'', ''microsoft.docs.mcp''].'
  validation: passed
