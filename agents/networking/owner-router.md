...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: "Read, triage:lookup_service_owner, triage:lookup_oncall, triage:parse_codeowners, triage:lookup_recent_assignees, triage:lookup_recent_committers".'
  validation: passed
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/mcp/x-bug-triage/agents/owner-router.md
