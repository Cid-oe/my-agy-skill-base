---
name: trading-uses-conviction-tracking-with-thesis-outcome-correlation
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/trading uses conviction tracking with thesis-outcome correlation.md
