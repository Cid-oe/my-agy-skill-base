---
name: ibis-framework-maps-claim-based-architecture-to-structured-argumentation
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/IBIS framework maps claim-based architecture to structured argumentation.md
