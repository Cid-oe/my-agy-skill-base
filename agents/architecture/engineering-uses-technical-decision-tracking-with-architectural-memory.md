---
name: engineering-uses-technical-decision-tracking-with-architectural-memory
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/engineering uses technical decision tracking with architectural memory.md
