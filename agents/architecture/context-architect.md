...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''search/codebase'', ''search/usages'', ''read/problems'', ''read/readFile'', ''edit/editFiles'', ''execute/runInTerminal'', ''execute/getTerminalOutput'', ''web/fetch''].'
  validation: passed
