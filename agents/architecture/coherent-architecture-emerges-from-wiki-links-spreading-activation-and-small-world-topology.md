---
name: coherent-architecture-emerges-from-wiki-links-spreading-activation-and-small-world-topology
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/coherent architecture emerges from wiki links spreading activation and small-world topology.md
