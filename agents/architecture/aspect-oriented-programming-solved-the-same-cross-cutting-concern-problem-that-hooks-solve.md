---
name: aspect-oriented-programming-solved-the-same-cross-cutting-concern-problem-that-hooks-solve
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/aspect-oriented programming solved the same cross-cutting concern problem that hooks solve.md
