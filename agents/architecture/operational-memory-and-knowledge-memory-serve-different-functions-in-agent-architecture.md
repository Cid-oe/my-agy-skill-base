---
name: operational-memory-and-knowledge-memory-serve-different-functions-in-agent-architecture
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/operational memory and knowledge memory serve different functions in agent architecture.md
