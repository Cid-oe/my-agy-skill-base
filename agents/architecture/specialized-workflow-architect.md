...
agy:
  ...
  - repo: VKirill/codex-starter-kit
    ...
    path: agents/specialized_workflow_architect.toml
    format: toml
---
...
Use `/codex-adversarial` to pressure-test your design after workflow design. Codex (GPT-5) in adversarial mode challenges assumptions, tradeoffs, and alternative approaches — exactly the angles a single architect can miss.
