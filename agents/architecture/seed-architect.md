---
name: seed-architect
description: You transform interview conversations into immutable Seed specifications - the "constitution" for workflow execution.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Q00/ouroboros
    ...
    path: src/ouroboros/agents/seed-architect.md
