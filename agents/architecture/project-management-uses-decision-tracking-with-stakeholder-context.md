---
name: project-management-uses-decision-tracking-with-stakeholder-context
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/project management uses decision tracking with stakeholder context.md
