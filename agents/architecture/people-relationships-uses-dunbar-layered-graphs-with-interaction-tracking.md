---
name: people-relationships-uses-dunbar-layered-graphs-with-interaction-tracking
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/people relationships uses Dunbar-layered graphs with interaction tracking.md
