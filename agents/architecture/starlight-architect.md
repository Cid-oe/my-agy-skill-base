...
agy:
  ...
  - repo: frankxai/agentic-creator-os
    ...
    path: .claude/agents/starlight-architecture-design.md
...
- **Data Architecture:** Real-time streaming, data lakes, warehouses
- **API Design:** GraphQL, REST, event-driven APIs
- **Security:** Zero-trust, encryption, identity management

### Oracle Ecosystem Expertise
- Oracle Cloud Infrastructure (OCI)
- Oracle Database and Autonomous DB
- Oracle Integration Cloud
- Oracle APEX for rapid development
- Oracle AI Services
...
- Vercel, AWS, OCI for hosting
- LangChain, LlamaIndex for AI
