...
agy:
  ...
  - repo: ruvnet/ruflo
    ...
    path: v3/@claude-flow/cli/.claude/agents/sparc/architecture.md
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/sparc/architecture.md
    format: markdown-frontmatter
  - repo: mikeyobrien/ralph-orchestrator
    author: mikeyobrien
    license: MIT
    url: https://github.com/mikeyobrien/ralph-orchestrator
    path: .agents/summary/architecture.md
    format: markdown-frontmatter
---
