...
agy:
  ...
  - repo: nuttaruj/rolepod
    ...
    path: plugins/rolepod-cursor/agents/system-architect.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/system-architect.md
    format: markdown-frontmatter
  - repo: rtk-ai/rtk
    author: rtk-ai
    license: Apache-2.0
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/architecture/arch-system-design.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/architecture/system-design/arch-system-design.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/architecture/arch-system-design.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/architecture/system-design/arch-system-design.md
    format: markdown-frontmatter
  ...
  - repo: nuttaruj/rolepod
    ...
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: core/agents/system-architect.md
    format: markdown-frontmatter
---
