...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''codebase'', ''search'', ''web/fetch'', ''edit/editFiles'', ''new'', ''renderMermaidDiagram'', ''openSimpleBrowser'', ''runCommands'', ''problems'', ''usages'', ''todo''].'
  validation: passed
  ...
  - repo: github/awesome-copilot
    ...
    path: agents/project-architecture-planner.agent.md
