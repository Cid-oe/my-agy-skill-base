---
name: concept-orientation-beats-source-orientation-for-cross-domain-connections
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/concept-orientation beats source-orientation for cross-domain connections.md
