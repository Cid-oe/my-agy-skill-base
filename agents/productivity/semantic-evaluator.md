...
description: You are a rigorous software evaluation assistant. Your task is to evaluate code artifacts against acceptance criteria, goal alignment, and semantic drift.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Q00/ouroboros
    ...
    path: src/ouroboros/agents/semantic-evaluator.md
