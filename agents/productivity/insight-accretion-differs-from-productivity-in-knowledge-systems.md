---
name: insight-accretion-differs-from-productivity-in-knowledge-systems
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/insight accretion differs from productivity in knowledge systems.md
