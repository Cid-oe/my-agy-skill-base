---
name: inline-links-carry-richer-relationship-data-than-metadata-fields
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/inline links carry richer relationship data than metadata fields.md
