---
name: maintenance-targeting-should-prioritize-mechanism-and-theory-notes
...
agy:
  ...
  tags:
  - maintenance targeting should prioritize mechanism and theory notes
  compatibility:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/maintenance targeting should prioritize mechanism and theory notes.md
