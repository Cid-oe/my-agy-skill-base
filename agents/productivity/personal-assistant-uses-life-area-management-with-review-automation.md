---
name: personal-assistant-uses-life-area-management-with-review-automation
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/personal assistant uses life area management with review automation.md
