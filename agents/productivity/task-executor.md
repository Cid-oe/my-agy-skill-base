...
agy:
  ...
  - repo: shinpr/claude-code-workflows
    ...
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/task-executor.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows/agents/task-executor.md
    format: markdown-frontmatter
  - repo: eyaltoledano/claude-task-master
    author: eyaltoledano
    license: NOASSERTION
    url: https://github.com/eyaltoledano/claude-task-master
    path: packages/claude-code-plugin/agents/task-executor.md
    format: markdown-frontmatter
