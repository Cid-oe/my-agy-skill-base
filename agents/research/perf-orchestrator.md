...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Task, Bash(git:*), Bash(npm:*), Bash(pnpm:*), Bash(yarn:*), Bash(cargo:*), Bash(go:*), Bash(pytest:*), Bash(python:*), Bash(mvn:*), Bash(gradle:*), Bash(node:*).'
  validation: passed
  ...
  - repo: composio-community/awesome-claude-plugins
    ...
    path: perf/agents/perf-orchestrator.md
