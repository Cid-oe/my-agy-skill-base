...
agy:
  ...
  - repo: nuttaruj/rolepod
    ...
    path: plugins/rolepod-cursor/agents/scout.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/scout.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: core/agents/scout.md
    format: markdown-frontmatter
  - repo: can1357/oh-my-pi
    author: can1357
    license: MIT
    url: https://github.com/can1357/oh-my-pi
    path: packages/coding-agent/src/prompts/agents/scout.md
    format: markdown-frontmatter
---
