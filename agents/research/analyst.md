...
agy:
  ...
  validation: passed
  imported: '2026-08-26T08:59:07+00:00'
  sources:
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/analysis/code-analyzer.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/analysis/code-analyzer.md
    format: markdown-frontmatter
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/ai-agency/hyperflow/agents/analyst.md
    format: markdown-frontmatter
  - repo: sodam-ai/SoDam-Agent
    author: sodam-ai
    license: Apache-2.0
    url: https://github.com/sodam-ai/SoDam-Agent
    path: plugins/research-team/agents/analyst.md
    format: markdown-frontmatter
---
