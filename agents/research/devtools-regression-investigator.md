...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''codebase'', ''search'', ''fetch'', ''findTestFiles'', ''problems'', ''runCommands'', ''runTasks'', ''runTests'', ''terminalLastCommand'', ''terminalSelection'', ''testFailure'', ''openSimpleBrowser''].'
  validation: passed
