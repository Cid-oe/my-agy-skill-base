...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, firecrawl, exa. Merged 3 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: davepoon/buildwithclaude
    ...
    path: plugins/gsd/agents/gsd-phase-researcher.md
    format: markdown-frontmatter
  - repo: frankxai/agentic-creator-os
    author: frankxai
    license: ''
    url: https://github.com/frankxai/agentic-creator-os
    path: .agents/gsd/gsd-phase-researcher.md
    format: markdown-frontmatter
---
