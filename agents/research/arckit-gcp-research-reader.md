...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Glob", "Grep", "TodoWrite", "mcp__plugin_arckit_google-developer-knowledge__search_documents", "mcp__plugin_arckit_google-developer-knowledge__get_document", "mcp__plugin_arckit_google-developer-knowledge__batch_get_documents"].'
  validation: passed
  ...
  - repo: tractorjuice/arc-kit
    ...
    path: plugins/arckit-claude/agents/arckit-gcp-research-reader.md
