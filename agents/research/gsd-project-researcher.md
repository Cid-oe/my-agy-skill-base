...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, firecrawl, exa. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: davepoon/buildwithclaude
    ...
    path: plugins/gsd/agents/gsd-project-researcher.md
    format: markdown-frontmatter
---
