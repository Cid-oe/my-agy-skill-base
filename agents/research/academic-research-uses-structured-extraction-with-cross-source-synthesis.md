---
name: academic-research-uses-structured-extraction-with-cross-source-synthesis
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/academic research uses structured extraction with cross-source synthesis.md
