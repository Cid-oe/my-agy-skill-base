...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [read_file, grep_search, replace, google_web_search, read_many_files, ask_user]. Merged 4 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: josstei/maestro-orchestrate
    ...
    path: claude/src/agents/product-manager.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: plugins/maestro/src/agents/product-manager.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: src/agents/product-manager.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: agents/product_manager.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
  ...
  - repo: josstei/maestro-orchestrate
    ...
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: qwen/agents/product_manager.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: core/agents/product-manager.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod-cursor/agents/product-manager.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/product-manager.md
    format: markdown-frontmatter
---
