...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''changes'', ''codebase'', ''web/fetch'', ''findTestFiles'', ''githubRepo'', ''openSimpleBrowser'', ''problems'', ''search'', ''searchResults'', ''terminalLastCommand'', ''terminalSelection'', ''usages'', ''vscodeAPI''].'
  validation: passed
