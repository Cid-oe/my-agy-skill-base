...
agy:
  ...
  - repo: dongbeixiaohuo/writing-agent
    ...
    path: .claude/agents/research-expert.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: claude-runtime/agents/research-expert.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: plugins/writing-agent/agents/research-expert.md
    format: markdown-frontmatter
  - repo: fusengine/agents
    author: fusengine
    license: MIT
    url: https://github.com/fusengine/agents
    path: plugins/ai-pilot/agents/research-expert.md
    format: markdown-frontmatter
---
