---
name: dense-interlinked-research-claims-enable-derivation-while-sparse-references-only-enable-templating
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/dense interlinked research claims enable derivation while sparse references only enable templating.md
