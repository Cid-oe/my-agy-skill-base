---
name: therapy-journal-uses-warm-personality-with-pattern-detection-for-emotional-processing
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/therapy journal uses warm personality with pattern detection for emotional processing.md
