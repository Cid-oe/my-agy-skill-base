...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''edit/editFiles'', ''search/codebase'', ''search/usages'', ''execute/runInTerminal'', ''read/terminalLastCommand'', ''read/terminalSelection'', ''read/problems'', ''web/fetch''].'
  validation: passed
