...
agy:
  ...
  category: data
  tags:
  - engineering_ai_data_remediation_engineer
  compatibility:
  ...
  - repo: VKirill/codex-starter-kit
    ...
    path: agents/engineering_ai_data_remediation_engineer.toml
    format: toml
---
...
### MCP / Tool Routing
- Use Postgres MCP for safe schema/query inspection before proposing database changes.
- Use GitNexus to understand callers, data flows, and impact before editing pipeline or persistence symbols.
- Use Serena for targeted symbol navigation and edits.
- Use Context7 for current ORM/database/framework docs.

### Skill Routing
- Prefer data-engineer, database-design, database-migration, postgresql, postgresql-optimization, sql-pro, prisma-expert, drizzle-orm-expert, testing-patterns, and Superpowers verification skills as relevant.
- Do not use UI/design/mobile/bot skills unless the task explicitly spans those domains.
</CODEx-TOOLING-SKILL-ROUTING>
