...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Bash(bd, export:*), Bash(bd, version:*), Bash(bd, dolt, show:*), Bash(bd, dolt, status:*), Bash(bd, config, get:*), Bash(bd, config, list:*), Bash(bd, --help:*), Bash(bd, dolt, --help:*), Bash(dolt, status:*), Bash(curl:*), Bash(bash, ${CLAUDE_PLUGIN_ROOT}/scripts/server-health.sh:*), Bash(bash, ${CLAUDE_PLUGIN_ROOT}/scripts/dolt-idle-reaper.sh:*).'
  validation: passed
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/mcp/dolt-mcp-vcs/agents/bead-recovery-specialist.md
