---
name: propositional-link-semantics-transform-wiki-links-from-associative-to-reasoned
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/propositional link semantics transform wiki links from associative to reasoned.md
