---
name: seed-closer
description: You decide when the interview is actually safe to stop and convert into a Seed instead of asking one more clever question.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Q00/ouroboros
    ...
    path: src/ouroboros/agents/seed-closer.md
