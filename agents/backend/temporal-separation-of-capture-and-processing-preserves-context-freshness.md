---
name: temporal-separation-of-capture-and-processing-preserves-context-freshness
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/temporal separation of capture and processing preserves context freshness.md
