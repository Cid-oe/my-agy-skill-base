...
model: inherit
tools:
- mcp__omega-memory__omega_store
- mcp__omega-memory__omega_call
- mcp__omega-memory__omega_welcome
- mcp__omega-memory__omega_protocol
- mcp__omega-memory__omega_tools
mcpServers:
- omega-memory
agy:
  version: 1.0.0
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: omega-memory.'
  validation: passed
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    path: plugins/omega-memory/agents/omega-memory.md
