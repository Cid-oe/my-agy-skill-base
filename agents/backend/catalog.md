---
name: catalog
description: This catalog enumerates every slide template the `mckinsey_pptx` plugin can produce.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  validation: passed
  imported: '2026-08-26T09:08:29+00:00'
  sources:
  - repo: seulee26/mckinsey-pptx
    author: seulee26
    license: NOASSERTION
    url: https://github.com/seulee26/mckinsey-pptx
    path: mckinsey_pptx/agent/CATALOG.md
