...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Glob", "Grep", "WebSearch", "WebFetch", "TodoWrite", "mcp__plugin_arckit_govreposcrape__search_uk_gov_code", "mcp__plugin_arckit_datacommons-mcp__search_indicators", "mcp__plugin_arckit_datacommons-mcp__get_observations"].'
  validation: passed
  ...
  - repo: tractorjuice/arc-kit
    ...
    path: plugins/arckit-claude/agents/arckit-datascout-reader.md
