---
name: smartpackdebt-inexon-executor-1
...
agy:
  ...
  category: backend
  tags:
  - SMARTPACKDEBT-inexon-executor-1
  compatibility:
  ...
  - repo: PeonPing/peon-ping
    ...
    path: .gitban/agents/executor/inbox/SMARTPACKDEBT-inexon-executor-1.md
    format: markdown-frontmatter
---

Activate your venv first: `.\.venv\Scripts\Activate.ps1`

The code for the gitban card with id inexon has been REJECTED with 6 blockers as of commit 4126d41. Please implement the following mandatory changes.
