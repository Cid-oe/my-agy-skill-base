---
name: note-titles-should-function-as-apis-enabling-sentence-transclusion
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/note titles should function as APIs enabling sentence transclusion.md
