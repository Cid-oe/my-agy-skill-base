---
name: source-pin
description: This directory vendors selected files from SkillsBench for native Terminus2 parity.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  validation: passed
  imported: '2026-08-26T09:08:15+00:00'
  sources:
  - repo: A-EVO-Lab/a-evolve
    author: A-EVO-Lab
    license: ''
    url: https://github.com/A-EVO-Lab/a-evolve
    path: agent_evolve/agents/skillbench/official_terminus/SOURCE_PIN.md
