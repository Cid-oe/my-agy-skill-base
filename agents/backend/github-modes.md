...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: claude-flow.'
  validation: passed
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/github/github-modes.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/github/github-modes.md
    format: markdown-frontmatter
