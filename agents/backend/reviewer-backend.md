...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Glob", "Grep", "Bash"]. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  imported: '2026-08-26T09:06:21+00:00'
  sources:
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    path: plugins/craftsman/agents/reviewer.md
    format: markdown-frontmatter
---
