---
name: ralph-adapter-system
description: 'Ralph supports multiple CLI backends through a layered adapter system:'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: mikeyobrien/ralph-orchestrator
    ...
    path: .agents/planning/2026-03-03-roo-cli-provider/research/ralph-adapter-system.md
