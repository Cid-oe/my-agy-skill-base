...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [Read, Grep]. Merged 6 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: athola/claude-night-market
    ...
    path: plugins/pensive/agents/code-reviewer.md
  ...
  - repo: luongnv89/claude-howto
    ...
    path: uk/04-subagents/code-reviewer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: vi/04-subagents/code-reviewer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: zh/04-subagents/code-reviewer.md
    format: markdown-frontmatter
