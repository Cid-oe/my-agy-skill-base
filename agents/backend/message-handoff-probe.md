---
name: message-handoff-probe
description: This diagnostic intentionally bypasses the repository's recommended Hook. It
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Utopia-V/mixagents
    ...
    path: packages/codex-deepseek-subagent/prompts/message-handoff-probe.md
