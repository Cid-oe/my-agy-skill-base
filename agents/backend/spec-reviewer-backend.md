---
name: spec-reviewer-backend
description: You are a specification reviewer dispatched by Godmode's think skill. Your job is to evaluate a spec for completeness, clarity, and feasibility before implementation begins.
kind: local
model: inherit
agy:
  version: 1.0.0
