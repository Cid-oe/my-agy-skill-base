...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''search/codebase'', ''search/usages'', ''edit/editFiles'', ''vscode/extensions'', ''web/fetch'', ''vscode/openSimpleBrowser'', ''read/problems'', ''execute/runTests'', ''read/terminalLastCommand'', ''read/terminalSelection'', ''execute/testFailure'', ''vscode/vscodeAPI''].'
  validation: passed
