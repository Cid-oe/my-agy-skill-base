...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Bash(bd, dolt, show:*), Bash(bd, dolt, remote, list:*), Bash(bd, dolt, status:*), Bash(bd, dolt, --help:*), Bash(bd, init, --help:*), Bash(bd, backup, --help:*), Bash(dolt, remote, -v:*), Bash(curl:*), Bash(bash, ${CLAUDE_PLUGIN_ROOT}/scripts/server-health.sh:*), Bash(bash, ${CLAUDE_PLUGIN_ROOT}/scripts/dolt-idle-reaper.sh:*).'
  validation: passed
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/mcp/dolt-mcp-vcs/agents/dolt-sync-advisor.md
