...
- mcp__github__list_artifacts
- mcp__github__download_artifact
- mcp__github__search_repositories
- mcp__github__search_code
- mcp__github__search_issues
- mcp__github__get_user
- mcp__github__list_repos_for_user
...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: github, basic-memory, zen.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/universal/git-expert.md
