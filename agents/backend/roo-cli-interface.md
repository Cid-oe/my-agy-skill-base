---
name: roo-cli-interface
description: '- **Binary name**: `roo` (installed via npm at `/Users/skven/.local/share/mise/installs/node/20.20.0/bin/roo`)'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: mikeyobrien/ralph-orchestrator
    ...
    path: .agents/planning/2026-03-03-roo-cli-provider/research/roo-cli-interface.md
