...
agy:
  ...
  - repo: ruvnet/ruflo
    ...
    path: v3/@claude-flow/cli/.claude/agents/development/dev-backend-api.md
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/development/dev-backend-api.md
    format: markdown-frontmatter
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/development/backend/dev-backend-api.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/development/backend/dev-backend-api.md
    format: markdown-frontmatter
  - repo: frankxai/agentic-creator-os
    author: frankxai
    license: ''
  ...
  - repo: sodam-ai/SoDam-Agent
    ...
    path: plugins/web-app-team/agents/backend-dev.md
    format: markdown-frontmatter
---
