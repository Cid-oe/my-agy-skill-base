---
name: plan-backend
description: '- [ ] Step 1: Add roo backend definitions to `cli_backend.rs`'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: mikeyobrien/ralph-orchestrator
    ...
    path: .agents/planning/2026-03-03-roo-cli-provider/implementation/plan.md
    format: markdown-frontmatter
  - repo: mikeyobrien/ralph-orchestrator
    author: mikeyobrien
    license: MIT
    url: https://github.com/mikeyobrien/ralph-orchestrator
    path: .agents/scratchpad/roo-cli-provider/plan.md
    format: markdown-frontmatter
---
