---
name: playbooks
description: 'Every roadmap item has three independent axes:'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Spielewoy/autoprompt-skill
    ...
    path: agents/claude/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/codex/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/deepseek/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/kilo/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/omp/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/opencode/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/reasonix/PLAYBOOKS.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/vscode/PLAYBOOKS.md
    format: markdown-frontmatter
---
...
There is no separate intake round trip on a new run. The first useful roadmap author proves RUN/READ/WRITE when no trusted supervisor attestation exists, inspects the repository, classifies scope, selects frameworks, and writes the executable `ROADMAP.md`.
...
The accounting covers useful scope workers. The runtime harness may own orchestration without adding a dedicated preflight, intake, or scope-coordinator agent round trip.

External research runs only when the mission needs current external facts. Repository-only work does not pay a research round trip. A rejected roadmap keeps accepted scout evidence and repairs only named items.
...
An implementation-ready item dispatches directly to G4. G1 runs only for debug/depth-lock work, an explicit unresolved design fork, `requiresDetailedPlan: true`, or a worker-reported `PLAN-CONFLICT`.
...
- Independent items share a launch group and run concurrently when the execution mode permits.
...
- Independent within-feature parts may fan out from the implementer when boundaries are disjoint.
...
A SMASH, REJECT, FAILED verification, sign-off failure, sweep P0/P1, or NOT-DONE goal check re-enters the owning roadmap item or creates a bounded debug item. Accepted evidence survives. Repairs target only named failures. Arbitration chooses among safe mission-advancing options but cannot waive an open P0/P1, the coverage floor, or a required real verification.
