---
name: context-phrase-clarity-determines-how-deep-a-navigation-hierarchy-can-scale
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/context phrase clarity determines how deep a navigation hierarchy can scale.md
