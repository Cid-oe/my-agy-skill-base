---
name: implicit-dependencies-create-distributed-monoliths-that-fail-silently-across-configurations
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/implicit dependencies create distributed monoliths that fail silently across configurations.md
