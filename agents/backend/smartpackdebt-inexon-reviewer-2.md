...
agy:
  ...
  category: backend
  tags:
  - SMARTPACKDEBT-inexon-reviewer-2
  compatibility:
  ...
  - repo: PeonPing/peon-ping
    ...
    path: .gitban/agents/reviewer/inbox/SMARTPACKDEBT-inexon-reviewer-2.md
