---
name: four-abstraction-layers-separate-platform-agnostic-from-platform-dependent-knowledge-system-features
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/four abstraction layers separate platform-agnostic from platform-dependent knowledge system features.md
