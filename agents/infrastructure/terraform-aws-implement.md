...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [execute/getTerminalOutput, execute/runInTerminal, read/problems, read/readFile, read/terminalSelection, read/terminalLastCommand, agent, edit/createDirectory, edit/createFile, edit/editFiles, search, web/fetch, todo].'
  validation: passed
  ...
  - repo: github/awesome-copilot
    ...
    path: agents/terraform-aws-implement.agent.md
