...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''read'', ''edit'', ''search'', ''web'', ''execute'', ''todo'', ''runSubagent'', ''azure-mcp/*'', ''ms-azuretools.vscode-azure-github-copilot/azure_query_azure_resource_graph''].'
  validation: passed
