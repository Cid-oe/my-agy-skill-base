---
name: markdown-plus-yaml-plus-ripgrep-implements-a-queryable-graph-database-without-infrastructure
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/markdown plus YAML plus ripgrep implements a queryable graph database without infrastructure.md
