---
name: platform-capability-tiers-determine-which-knowledge-system-features-can-be-implemented
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/platform capability tiers determine which knowledge system features can be implemented.md
