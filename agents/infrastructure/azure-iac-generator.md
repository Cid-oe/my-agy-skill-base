...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''vscode'', ''execute'', ''read'', ''edit'', ''search'', ''web'', ''agent'', ''azure-mcp/azureterraformbestpractices'', ''azure-mcp/bicepschema'', ''azure-mcp/search'', ''pulumi-mcp/get-type'', ''runSubagent''].'
  validation: passed
