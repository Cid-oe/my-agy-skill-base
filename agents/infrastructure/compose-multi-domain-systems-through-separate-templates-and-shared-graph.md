---
name: compose-multi-domain-systems-through-separate-templates-and-shared-graph
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/compose multi-domain systems through separate templates and shared graph.md
