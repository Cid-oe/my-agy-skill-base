...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: github, basic-memory. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/automation/cicd-pipeline-engineer.md
