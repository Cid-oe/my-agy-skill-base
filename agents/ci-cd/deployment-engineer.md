...
agy:
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/03-infrastructure/deployment-engineer.md
    format: markdown-frontmatter
  ...
  - repo: rohitg00/awesome-claude-code-toolkit
    ...
    path: agents/infrastructure/deployment-engineer.md
    format: markdown-frontmatter
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    path: plugins/deployment-engineer/agents/deployment-engineer.md
    format: markdown-frontmatter
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/wshobson/deployment-engineer.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/claude-code-sub-agents/infrastructure/deployment-engineer.md
    format: markdown-frontmatter
---
