...
agy:
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/packages/devops-automation-pack/plugins/06-deployment/agents/deployment-specialist.md
  ...
  - repo: luongnv89/claude-howto
    ...
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: ja/07-plugins/devops-automation/agents/deployment-specialist.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: uk/07-plugins/devops-automation/agents/deployment-specialist.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: vi/07-plugins/devops-automation/agents/deployment-specialist.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: zh/07-plugins/devops-automation/agents/deployment-specialist.md
    format: markdown-frontmatter
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    author: jeremylongshore
    license: MIT
    url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills
    path: plugins/packages/fullstack-starter-pack/agents/deployment-specialist.md
    format: markdown-frontmatter
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    author: jeremylongshore
    license: MIT
    url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills
    path: plugins/packages/fullstack-starter-pack/plugins/04-integration/agents/deployment-specialist.md
    format: markdown-frontmatter
  - repo: avivl/claude-007-agents
    author: avivl
    license: MIT
    url: https://github.com/avivl/claude-007-agents
    path: .claude/agents/devops/deployment-specialist.md
    format: markdown-frontmatter
---
