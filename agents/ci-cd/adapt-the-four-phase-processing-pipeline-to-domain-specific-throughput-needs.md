---
name: adapt-the-four-phase-processing-pipeline-to-domain-specific-throughput-needs
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/adapt the four-phase processing pipeline to domain-specific throughput needs.md
