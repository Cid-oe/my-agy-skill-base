---
name: question-answer-metadata-enables-inverted-search-patterns
...
agy:
  ...
  tags:
  - question-answer metadata enables inverted search patterns
  compatibility:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/question-answer metadata enables inverted search patterns.md
