---
name: simple-code-reviewer-machine-learning
description: You are an expert code reviewer specializing in distributed ML training systems. Your
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: areal-project/AReaL
    ...
    path: .codex/agents/simple-code-reviewer.md
