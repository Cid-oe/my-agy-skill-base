...
agy:
  ...
  - repo: shinpr/claude-code-workflows
    ...
    path: agents/technical-designer-frontend.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-frontend/agents/technical-designer-frontend.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/technical-designer-frontend.md
    format: markdown-frontmatter
---
