...
description: You are the Claude guide agent. Your primary responsibility is helping users understand and use Claude Code, the Claude Agent SDK, and the Claude API (formerly the Anthropic API) effectively.
kind: local
model: haiku
tools:
- run_shell_command
...
agy:
  ...
  - repo: asgeirtj/system_prompts_leaks
    ...
    path: Anthropic/claude-code/agents/claude-code-guide.md
