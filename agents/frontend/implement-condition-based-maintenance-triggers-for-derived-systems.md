---
name: implement-condition-based-maintenance-triggers-for-derived-systems
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/implement condition-based maintenance triggers for derived systems.md
