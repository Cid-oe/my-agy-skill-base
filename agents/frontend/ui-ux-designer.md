...
agy:
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/wshobson/ui-ux-designer.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: core/agents/ui-ux-designer.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod-cursor/agents/ui-ux-designer.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/ui-ux-designer.md
    format: markdown-frontmatter
---
