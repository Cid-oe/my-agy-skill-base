---
name: orchestrated-vault-creation-transforms-arscontexta-from-tool-to-autonomous-knowledge-factory
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/orchestrated vault creation transforms arscontexta from tool to autonomous knowledge factory.md
