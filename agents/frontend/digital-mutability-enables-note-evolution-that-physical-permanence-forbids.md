---
name: digital-mutability-enables-note-evolution-that-physical-permanence-forbids
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/digital mutability enables note evolution that physical permanence forbids.md
