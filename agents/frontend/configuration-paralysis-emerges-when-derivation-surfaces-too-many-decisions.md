---
name: configuration-paralysis-emerges-when-derivation-surfaces-too-many-decisions
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/configuration paralysis emerges when derivation surfaces too many decisions.md
