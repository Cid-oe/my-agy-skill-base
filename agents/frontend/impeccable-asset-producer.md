...
agy:
  ...
  - repo: pbakaus/impeccable
    ...
    path: skill/agents/impeccable-asset-producer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .claude/agents/impeccable-asset-producer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: plugin/agents/impeccable-asset-producer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .cursor/agents/impeccable-asset-producer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .github/agents/impeccable-asset-producer.agent.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .grok/agents/impeccable-asset-producer.md
    format: markdown-frontmatter
---
