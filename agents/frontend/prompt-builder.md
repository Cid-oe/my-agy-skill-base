...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''codebase'', ''edit/editFiles'', ''web/fetch'', ''githubRepo'', ''problems'', ''runCommands'', ''search'', ''searchResults'', ''terminalLastCommand'', ''terminalSelection'', ''usages'', ''terraform'', ''Microsoft, Docs'', ''context7''].'
  validation: passed
