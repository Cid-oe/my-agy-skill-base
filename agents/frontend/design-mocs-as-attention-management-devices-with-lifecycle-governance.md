---
name: design-mocs-as-attention-management-devices-with-lifecycle-governance
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/design MOCs as attention management devices with lifecycle governance.md
