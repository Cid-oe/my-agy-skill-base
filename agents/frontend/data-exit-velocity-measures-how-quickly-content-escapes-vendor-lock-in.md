---
name: data-exit-velocity-measures-how-quickly-content-escapes-vendor-lock-in
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/data exit velocity measures how quickly content escapes vendor lock-in.md
