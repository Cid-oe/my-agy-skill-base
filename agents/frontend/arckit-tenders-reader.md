...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Glob", "Grep", "TodoWrite", "mcp__plugin_arckit_uk-tenders__search_tenders", "mcp__plugin_arckit_uk-tenders__top_suppliers", "mcp__plugin_arckit_uk-tenders__awarded_value_by_buyer", "mcp__plugin_arckit_uk-tenders__aggregate_tenders", "mcp__plugin_arckit_uk-tenders__awards_over_time", "mcp__plugin_arckit_uk-tenders__get_tender", "mcp__plugin_arckit_uk-tenders__get_status"].'
  validation: passed
  ...
  - repo: tractorjuice/arc-kit
    ...
    path: plugins/arckit-claude/agents/arckit-tenders-reader.md
