---
name: skill-bundle-routing
description: Host provided a Tutti dynamic skill bundle.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: tutti-os/tutti
    ...
    path: packages/agent/runtimeprep/policy_templates/skill-bundle-routing.md
