...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, exa, sequential-thinking, fuse-browser.'
  validation: passed
  ...
  - repo: fusengine/agents
    ...
    path: plugins/laravel-expert/agents/laravel-expert.md
