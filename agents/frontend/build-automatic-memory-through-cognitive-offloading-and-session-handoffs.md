---
name: build-automatic-memory-through-cognitive-offloading-and-session-handoffs
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/build automatic memory through cognitive offloading and session handoffs.md
