...
agy:
  ...
  - repo: shinpr/claude-code-workflows
    ...
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-frontend/agents/document-reviewer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/document-reviewer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows/agents/document-reviewer.md
    format: markdown-frontmatter
---
