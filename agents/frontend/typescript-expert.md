...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, exa, sequential-thinking, fuse-browser. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: fusengine/agents
    ...
    path: plugins/typescript-expert/agents/typescript-expert.md
