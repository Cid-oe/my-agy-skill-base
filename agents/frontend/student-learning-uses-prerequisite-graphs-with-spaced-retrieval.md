---
name: student-learning-uses-prerequisite-graphs-with-spaced-retrieval
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/student learning uses prerequisite graphs with spaced retrieval.md
