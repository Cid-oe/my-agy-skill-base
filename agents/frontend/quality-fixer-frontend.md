...
agy:
  ...
  - repo: shinpr/claude-code-workflows
    ...
    path: agents/quality-fixer-frontend.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-frontend/agents/quality-fixer-frontend.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/quality-fixer-frontend.md
    format: markdown-frontmatter
---
