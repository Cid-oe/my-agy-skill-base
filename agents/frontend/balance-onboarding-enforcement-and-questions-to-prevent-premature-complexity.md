---
name: balance-onboarding-enforcement-and-questions-to-prevent-premature-complexity
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/balance onboarding enforcement and questions to prevent premature complexity.md
