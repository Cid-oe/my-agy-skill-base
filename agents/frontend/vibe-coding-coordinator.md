...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: basic-memory, task-master, context7, sequential-thinking, zen.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/context-orchestrators/vibe-coding-coordinator.md
