...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, exa, sequential-thinking, shadcn, gemini-design, fuse-browser.'
  validation: passed
  ...
  - repo: fusengine/agents
    ...
    path: plugins/nextjs-expert/agents/nextjs-expert.md
