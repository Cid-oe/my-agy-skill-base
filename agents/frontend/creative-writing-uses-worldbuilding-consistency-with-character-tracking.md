---
name: creative-writing-uses-worldbuilding-consistency-with-character-tracking
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/creative writing uses worldbuilding consistency with character tracking.md
