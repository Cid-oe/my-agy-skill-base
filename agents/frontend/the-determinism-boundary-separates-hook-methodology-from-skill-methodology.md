---
name: the-determinism-boundary-separates-hook-methodology-from-skill-methodology
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/the determinism boundary separates hook methodology from skill methodology.md
