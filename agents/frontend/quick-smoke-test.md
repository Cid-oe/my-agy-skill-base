...
description: Run this from any new Codex task after the Hook has been reviewed and trusted.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Utopia-V/mixagents
    ...
    path: packages/codex-deepseek-subagent/prompts/quick-smoke-test.md
