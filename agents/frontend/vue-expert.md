...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: basic-memory. Merged 5 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/frontend/vue-expert.md
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/02-language-specialists/vue-expert.md
    format: markdown-frontmatter
  ...
  - repo: 0xfurai/claude-code-subagents
    ...
    path: agents/vue-expert.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/claude-code-subagents/agents/vue-expert.md
    format: markdown-frontmatter
