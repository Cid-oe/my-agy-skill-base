---
name: retrieval-utility-should-drive-design-over-capture-completeness
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/retrieval utility should drive design over capture completeness.md
