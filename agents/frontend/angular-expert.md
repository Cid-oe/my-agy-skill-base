...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: basic-memory. Merged 2 same-name variants into one canonical agent.'
  validation: passed
