---
name: schema-evolution-follows-observe-then-formalize-not-design-then-enforce
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/schema evolution follows observe-then-formalize not design-then-enforce.md
