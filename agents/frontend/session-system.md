---
name: session-system
description: Sessions are stored per project data directory, not directly in the genome root.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/session-system.md
