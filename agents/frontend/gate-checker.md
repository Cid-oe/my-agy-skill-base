...
agy:
  ...
  validation: passed
  imported: '2026-08-26T09:12:18+00:00'
  sources:
  - repo: stevesolun/micro-skills
    author: stevesolun
    license: MIT
    url: https://github.com/stevesolun/micro-skills
    path: micro-skill-pipeline/agents/gate-checker.md
