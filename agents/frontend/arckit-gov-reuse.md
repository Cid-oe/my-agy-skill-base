...
agy:
  ...
  - repo: tractorjuice/arc-kit
    ...
    path: plugins/arckit-claude/agents/arckit-gov-reuse.md
...
- **Templates** — `${CLAUDE_PLUGIN_ROOT}/templates/gov-reuse-template.md` (override at `.arckit/templates-custom/gov-reuse-template.md`)
