...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, astro-docs, exa, sequential-thinking, shadcn, gemini-design, fuse-browser. Merged 2 same-name variants into one canonical agent.'
  validation: passed
