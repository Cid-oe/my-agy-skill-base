---
name: the-fix-versus-report-decision-depends-on-determinism-reversibility-and-accumulated-trust
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/the fix-versus-report decision depends on determinism reversibility and accumulated trust.md
