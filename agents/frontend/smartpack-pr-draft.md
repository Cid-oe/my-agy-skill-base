---
name: smartpack-pr-draft
description: '**Title:** `sprint/SMARTPACK: per-project pack assignment via path_rules and config key cleanup`'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: PeonPing/peon-ping
    ...
    path: .gitban/agents/pr/inbox/SMARTPACK-pr-draft.md
