---
name: payment-integration-frontend
...
agy:
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/claude-code-sub-agents/specialization/payment-integration.md
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/07-specialized-domains/payment-integration.md
    format: markdown-frontmatter
---
