...
agy:
  ...
  - repo: pbakaus/impeccable
    ...
    path: .claude/agents/impeccable-finish-reviewer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .cursor/agents/impeccable-finish-reviewer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .github/agents/impeccable-finish-reviewer.agent.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .grok/agents/impeccable-finish-reviewer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: plugin/agents/impeccable-finish-reviewer.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: skill/agents/impeccable-finish-reviewer.md
    format: markdown-frontmatter
---
