...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: "Read, triage:search_issues, triage:inspect_recent_commits, triage:inspect_code_paths, triage:check_recent_deploys".'
  validation: passed
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/mcp/x-bug-triage/agents/repo-scanner.md
