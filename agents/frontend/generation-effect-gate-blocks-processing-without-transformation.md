---
name: generation-effect-gate-blocks-processing-without-transformation
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/generation effect gate blocks processing without transformation.md
