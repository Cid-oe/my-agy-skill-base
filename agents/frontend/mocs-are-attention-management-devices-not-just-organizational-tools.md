---
name: mocs-are-attention-management-devices-not-just-organizational-tools
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/MOCs are attention management devices not just organizational tools.md
