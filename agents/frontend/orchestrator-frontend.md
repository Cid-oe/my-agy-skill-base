...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: task-master, basic-memory, sequential-thinking, zen. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: athola/claude-night-market
    ...
    path: plugins/egregore/agents/orchestrator.md
    format: markdown-frontmatter
---
