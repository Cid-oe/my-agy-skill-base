---
name: maintenance-scheduling-frequency-should-match-consequence-speed-not-detection-capability
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/maintenance scheduling frequency should match consequence speed not detection capability.md
