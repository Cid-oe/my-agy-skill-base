---
name: the-no-wrong-patches-guarantee-ensures-any-valid-module-combination-produces-a-valid-system
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/the no wrong patches guarantee ensures any valid module combination produces a valid system.md
