---
name: complete-navigation-requires-four-complementary-types-that-no-single-mechanism-provides
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/complete navigation requires four complementary types that no single mechanism provides.md
