---
name: idempotent-maintenance-operations-are-safe-to-automate-because-running-them-twice-produces-the-same-result-as-running-them-once
...
agy:
  ...
  validation: passed
  imported: '2026-08-26T09:00:46+00:00'
  sources:
  - repo: agenticnotetaking/arscontexta
    author: agenticnotetaking
    license: MIT
    url: https://github.com/agenticnotetaking/arscontexta
    path: methodology/idempotent maintenance operations are safe to automate because running them twice produces the same result as running them once.md
