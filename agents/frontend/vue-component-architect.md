...
agy:
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/awesome-claude-agents/agents/specialized/vue/vue-component-architect.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/awesome-claude-agents/agents/specialized/vue/vue-state-manager.md
    format: markdown-frontmatter
---
