...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: context7, sequential-thinking, magic. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: lst97/claude-code-sub-agents
    ...
    path: agents/development/full-stack-developer.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/claude-code-sub-agents/development/full-stack-developer.md
    format: markdown-frontmatter
---
