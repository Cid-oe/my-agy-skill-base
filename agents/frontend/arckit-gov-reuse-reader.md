...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Glob", "Grep", "WebFetch", "TodoWrite", "mcp__plugin_arckit_govreposcrape__search_uk_gov_code", "mcp__plugin_arckit_govreposcrape__dependency_compare"].'
  validation: passed
  ...
  - repo: tractorjuice/arc-kit
    ...
    path: plugins/arckit-claude/agents/arckit-gov-reuse-reader.md
