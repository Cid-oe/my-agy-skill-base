---
name: components
description: The foundational protocol crate providing shared types, error definitions, and traits used across all Ralph crates.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: mikeyobrien/ralph-orchestrator
    ...
    path: .agents/summary/components.md
