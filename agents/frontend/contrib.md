---
name: contrib
description: This guide explains how to add your own reference agent implementations to the benchmark system.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: trycua/cua
    ...
    path: libs/python/agent/benchmarks/contrib.md
