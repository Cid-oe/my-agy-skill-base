...
agy:
  ...
  - repo: dongbeixiaohuo/writing-agent
    ...
    path: plugins/writing-agent/agents/concretizer.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: claude-runtime/agents/concretizer.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: .claude/agents/concretizer.md
    format: markdown-frontmatter
---
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/scripts/verify_required_files.py" --project "[项目名]" --required 05_concrete_library.md
```
