---
name: tutti-model-allocation-model-tiers
description: This routing prior combines the packaged OpenSquilla provider ladders at
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: tutti-os/tutti
    ...
    path: packages/agent/runtimeprep/skill_templates/tutti-model-allocation-model-tiers.md
