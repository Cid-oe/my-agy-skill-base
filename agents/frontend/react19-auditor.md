...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''vscode/memory'', ''search'', ''search/usages'', ''web/fetch'', ''execute/getTerminalOutput'', ''execute/runInTerminal'', ''read/terminalLastCommand'', ''read/terminalSelection'', ''edit/editFiles''].'
  validation: passed
