...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Glob", "Grep", "WebFetch", "TodoWrite", "mcp__plugin_arckit_govreposcrape__search_uk_gov_code", "mcp__plugin_arckit_govreposcrape__vulnerability_exposure"].'
  validation: passed
  ...
  - repo: tractorjuice/arc-kit
    ...
    path: plugins/arckit-claude/agents/arckit-gov-landscape-reader.md
