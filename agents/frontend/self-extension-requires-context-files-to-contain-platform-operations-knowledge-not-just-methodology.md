---
name: self-extension-requires-context-files-to-contain-platform-operations-knowledge-not-just-methodology
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/self-extension requires context files to contain platform operations knowledge not just methodology.md
