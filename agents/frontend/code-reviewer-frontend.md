...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: github, basic-memory, zen. Merged 7 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/universal/code-reviewer.md
  ...
  - repo: shinpr/claude-code-workflows
    ...
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-frontend/agents/code-reviewer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/code-reviewer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows/agents/code-reviewer.md
    format: markdown-frontmatter
