---
name: guided-notes-might-outperform-post-hoc-structuring-for-high-volume-capture
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/guided notes might outperform post-hoc structuring for high-volume capture.md
