...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''vscode/memory'', ''search'', ''search/usages'', ''execute/getTerminalOutput'', ''execute/runInTerminal'', ''read/terminalLastCommand'', ''read/terminalSelection'', ''edit/editFiles'', ''web/fetch''].'
  validation: passed
