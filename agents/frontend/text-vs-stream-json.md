---
name: text-vs-stream-json
description: 'The developer running `ralph run -b roo` sees:'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: mikeyobrien/ralph-orchestrator
    ...
    path: .agents/planning/2026-03-03-roo-cli-provider/research/text-vs-stream-json.md
