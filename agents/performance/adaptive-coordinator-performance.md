---
name: adaptive-coordinator-performance
...
agy:
  ...
  - repo: ruvnet/ruflo
    ...
    path: v3/@claude-flow/cli/.claude/agents/swarm/adaptive-coordinator.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/swarm/adaptive-coordinator.md
    format: markdown-frontmatter
---
