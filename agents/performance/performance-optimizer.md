...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: basic-memory. Merged 13 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/universal/performance-optimizer.md
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/sublinear/performance-optimizer.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/sublinear/performance-optimizer.md
    format: markdown-frontmatter
  ...
  - repo: luongnv89/claude-howto
    ...
    path: uk/04-subagents/performance-optimizer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: 04-subagents/performance-optimizer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: ja/04-subagents/performance-optimizer.md
    format: markdown-frontmatter
  - repo: affaan-m/ECC
    author: affaan-m
    license: MIT
    url: https://github.com/affaan-m/ECC
    path: .kiro/agents/performance-optimizer.json
    format: json
  - repo: affaan-m/ECC
    author: affaan-m
    license: MIT
    url: https://github.com/affaan-m/ECC
    path: .kiro/agents/performance-optimizer.md
    format: markdown-frontmatter
  - repo: affaan-m/ECC
    author: affaan-m
    license: MIT
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/testing/code-cleanup/agents/performance-optimizer.md
    format: markdown-frontmatter
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/awesome-claude-agents/agents/core/performance-optimizer.md
    format: markdown-frontmatter
  ...
  - repo: CodeDraig/codex-subagents
    ...
    path: AGENTS/openai/performance-optimizer.toml
    format: toml
