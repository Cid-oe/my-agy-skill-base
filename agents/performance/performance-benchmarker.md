...
agy:
  ...
  - repo: ruvnet/ruflo
    ...
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/cli/.claude/agents/consensus/performance-benchmarker.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/consensus/performance-benchmarker.md
    format: markdown-frontmatter
  ...
  - repo: jnMetaCode/agency-orchestrator
    ...
    path: agency-agents/testing/testing-performance-benchmarker.md
    format: markdown-frontmatter
  - repo: ccplugins/awesome-claude-code-plugins
    author: ccplugins
    license: Apache-2.0
    url: https://github.com/ccplugins/awesome-claude-code-plugins
    path: plugins/performance-benchmarker/agents/performance-benchmarker.md
    format: markdown-frontmatter
---
