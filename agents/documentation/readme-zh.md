---
name: readme-zh
description: 基于 Claude Code Sub-Agents 功能构建的综合性 AI 驱动开发工作流系统。该系统通过协调多个专业化 AI 代理，将项目创意转化为生产就绪的代码。
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/claude-sub-agent/README-zh.md
    format: markdown-frontmatter
  - repo: shareAI-lab/learn-claude-code
    author: shareAI-lab
    license: MIT
    url: https://github.com/shareAI-lab/learn-claude-code
    path: s06_subagent/README.zh.md
    format: markdown-frontmatter
  ...
  - repo: liaohch3/claude-tap
    ...
    path: .agents/evidence/pr/pr329/README.zh.md
    format: markdown-frontmatter
---
