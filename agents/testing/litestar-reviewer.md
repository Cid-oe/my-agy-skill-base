...
agy:
  ...
  validation: passed
  imported: '2026-08-26T09:12:06+00:00'
  sources:
  - repo: litestar-org/litestar-skills
    author: litestar-org
    license: MIT
    url: https://github.com/litestar-org/litestar-skills
    path: .claude-plugin/agents/litestar-reviewer.md
    format: markdown-frontmatter
  - repo: litestar-org/litestar-skills
    author: litestar-org
    license: MIT
    url: https://github.com/litestar-org/litestar-skills
    path: .codex/agents/litestar-reviewer.toml
    format: toml
  - repo: litestar-org/litestar-skills
    author: litestar-org
    license: MIT
    url: https://github.com/litestar-org/litestar-skills
    path: .opencode/agents/litestar-reviewer.md
    format: markdown-frontmatter
  - repo: litestar-org/litestar-skills
    author: litestar-org
    license: MIT
    url: https://github.com/litestar-org/litestar-skills
    path: agents/litestar-reviewer.md
    format: markdown-frontmatter
  - repo: litestar-org/litestar-skills
    author: litestar-org
    license: MIT
    url: https://github.com/litestar-org/litestar-skills
    path: plugins/litestar/.codex/agents/litestar-reviewer.toml
    format: toml
---
