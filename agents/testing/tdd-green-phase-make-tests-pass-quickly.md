...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''github/*'', ''search/fileSearch'', ''edit/editFiles'', ''execute/runTests'', ''execute/runInTerminal'', ''execute/getTerminalOutput'', ''execute/testFailure'', ''read/readFile'', ''read/terminalLastCommand'', ''read/terminalSelection'', ''read/problems'', ''search/codebase''].'
  validation: passed
