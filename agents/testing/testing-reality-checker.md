...
agy:
  ...
  - repo: VKirill/codex-starter-kit
    ...
    path: agents/testing_reality_checker.toml
    format: toml
---
...
Use `/codex-review` for an independent second-opinion review after verifying the feature works. Codex (GPT-5) brings a different blind-spot profile than Claude — it often catches what Claude misses and vice versa.
