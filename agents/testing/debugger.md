...
agy:
  ...
  compatibility:
    ...
    score: 100
    notes: Converted directly; no manual steps required. Merged 27 same-name variants into one canonical agent.
  validation: passed
  ...
  - repo: luongnv89/claude-howto
    ...
    path: uk/04-subagents/debugger.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
  ...
  - repo: luongnv89/claude-howto
    ...
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: ja/04-subagents/debugger.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: vi/04-subagents/debugger.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: zh/04-subagents/debugger.md
    format: markdown-frontmatter
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/04-quality-security/debugger.md
    format: markdown-frontmatter
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/ai-agency/hyperflow/agents/debugger.md
    format: markdown-frontmatter
  ...
  - repo: CloudAI-X/claude-workflow-v2
    ...
    path: .codex/agents/debugger.toml
    format: toml
  - repo: CloudAI-X/claude-workflow-v2
    author: CloudAI-X
    license: MIT
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    path: plugins/craftsman/agents/debugger.md
    format: markdown-frontmatter
  ...
  - repo: josstei/maestro-orchestrate
    ...
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: qwen/agents/debugger.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: claude/src/agents/debugger.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: plugins/maestro/src/agents/debugger.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: src/agents/debugger.md
    format: markdown-frontmatter
  ...
  - repo: dshakes/compass
    ...
    license: MIT
    url: https://github.com/dshakes/compass
    path: plugins/core/agents/debugger.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/claude-code-sub-agents/quality-testing/debugger.md
    format: markdown-frontmatter
