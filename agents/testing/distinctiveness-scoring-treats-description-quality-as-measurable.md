---
name: distinctiveness-scoring-treats-description-quality-as-measurable
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/distinctiveness scoring treats description quality as measurable.md
