---
name: skills-encode-methodology-so-manual-execution-bypasses-quality-gates
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/skills encode methodology so manual execution bypasses quality gates.md
