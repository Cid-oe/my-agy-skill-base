...
agy:
  ...
  - repo: VKirill/codex-starter-kit
    ...
    path: agents/specialized_model_qa.toml
    format: toml
---
...
Use `/codex-review` for an independent second-opinion review after your model QA pass. Codex (GPT-5) brings a different blind-spot profile than Claude — it often catches what Claude misses and vice versa.
