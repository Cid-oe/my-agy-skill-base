---
name: wintest-od5a0c-reviewer-1
description: 'The executor claims: "The variable `$peonDebug` does not exist anywhere in the codebase. Grep across all `.ps1` files returns zero matches."'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: PeonPing/peon-ping
    ...
    path: .gitban/agents/reviewer/inbox/WINTEST-od5a0c-reviewer-1.md
