...
agy:
  ...
  - repo: shinpr/claude-code-workflows
    ...
    path: agents/quality-fixer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/quality-fixer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows/agents/quality-fixer.md
    format: markdown-frontmatter
  - repo: matt1398/claude-devtools
    author: matt1398
    license: MIT
    url: https://github.com/matt1398/claude-devtools
    path: .claude/agents/quality-fixer.md
    format: markdown-frontmatter
---
