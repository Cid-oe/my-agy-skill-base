...
agy:
  ...
  validation: passed
  imported: '2026-08-26T09:07:38+00:00'
  sources:
  ...
  - repo: rohitg00/awesome-claude-code-toolkit
    ...
    path: agents/quality-assurance/test-architect.md
    format: markdown-frontmatter
  - repo: alirezarezvani/claude-skills
    author: alirezarezvani
    license: MIT
    url: https://github.com/alirezarezvani/claude-skills
    path: engineering-team/playwright-pro/agents/test-architect.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: .claude/agents/v3/test-architect.md
    format: markdown-frontmatter
  - repo: CloudAI-X/claude-workflow-v2
    author: CloudAI-X
    license: MIT
    url: https://github.com/CloudAI-X/claude-workflow-v2
    path: .codex/agents/test-architect.toml
    format: toml
  - repo: dshakes/compass
    author: dshakes
    license: MIT
    url: https://github.com/dshakes/compass
    path: claude/agents/test-architect.md
    format: markdown-frontmatter
  - repo: dshakes/compass
    author: dshakes
    license: MIT
    url: https://github.com/dshakes/compass
    path: plugins/core/agents/test-architect.md
    format: markdown-frontmatter
---
