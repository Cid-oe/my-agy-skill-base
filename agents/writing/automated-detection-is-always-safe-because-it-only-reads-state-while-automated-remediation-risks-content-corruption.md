---
name: automated-detection-is-always-safe-because-it-only-reads-state-while-automated-remediation-risks-content-corruption
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/automated detection is always safe because it only reads state while automated remediation risks content corruption.md
