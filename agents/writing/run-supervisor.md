...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Bash(run-controller, start:*), Bash(run-controller, watch:*), Bash(run-controller, status:*), SendMessage.'
  validation: passed
  ...
  - repo: VKirill/claude-lane-stack
    ...
    path: agents/claude/run-supervisor.md
    format: markdown-frontmatter
  - repo: VKirill/claude-lane-stack
    author: VKirill
    license: MIT
    url: https://github.com/VKirill/claude-lane-stack
    path: plugins/lane-stack/agents/run-supervisor.md
    format: markdown-frontmatter
---
