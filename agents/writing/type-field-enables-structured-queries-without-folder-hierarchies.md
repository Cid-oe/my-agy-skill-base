---
name: type-field-enables-structured-queries-without-folder-hierarchies
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/type field enables structured queries without folder hierarchies.md
