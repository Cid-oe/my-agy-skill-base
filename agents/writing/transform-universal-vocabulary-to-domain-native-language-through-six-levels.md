---
name: transform-universal-vocabulary-to-domain-native-language-through-six-levels
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/transform universal vocabulary to domain-native language through six levels.md
