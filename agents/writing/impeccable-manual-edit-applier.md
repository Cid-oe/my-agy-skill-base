...
agy:
  ...
  - repo: pbakaus/impeccable
    ...
    path: .claude/agents/impeccable-manual-edit-applier.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .cursor/agents/impeccable-manual-edit-applier.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .github/agents/impeccable-manual-edit-applier.agent.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: .grok/agents/impeccable-manual-edit-applier.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: plugin/agents/impeccable-manual-edit-applier.md
    format: markdown-frontmatter
  - repo: pbakaus/impeccable
    author: pbakaus
    license: Apache-2.0
    url: https://github.com/pbakaus/impeccable
    path: skill/agents/impeccable-manual-edit-applier.md
    format: markdown-frontmatter
---
