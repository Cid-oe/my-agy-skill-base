...
agy:
  ...
  validation: passed
  imported: '2026-08-26T09:11:00+00:00'
  sources:
  - repo: ringlochid/oh-my-subagents
    author: ringlochid
    license: MIT
    url: https://github.com/ringlochid/oh-my-subagents
    path: .agents/standards/standards-writing.md
...
For Oh My Subagents, the preferred grouped files are:
