...
agy:
  ...
  - repo: dongbeixiaohuo/writing-agent
    ...
    path: plugins/writing-agent/agents/writing-executor.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: claude-runtime/agents/writing-executor.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: .claude/agents/writing-executor.md
    format: markdown-frontmatter
---
...
| **5. 删除空心金句** | 删除只有对仗、排比或口号感却没有事实重量的句子；保留带场景、代价或立场的压缩判断 | ❌"这不仅仅是...而是..."；✅"他省下十分钟解释，把三个月的信任一起省没了" |
...
## 版本记录
- v1.4.0 (2026-08-14): 统一金句语义为“删除空心口号、保留带场景和代价的判断句”，并移除重复规则。
