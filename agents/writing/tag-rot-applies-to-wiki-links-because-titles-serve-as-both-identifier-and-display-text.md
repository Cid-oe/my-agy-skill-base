---
name: tag-rot-applies-to-wiki-links-because-titles-serve-as-both-identifier-and-display-text
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/tag rot applies to wiki links because titles serve as both identifier and display text.md
