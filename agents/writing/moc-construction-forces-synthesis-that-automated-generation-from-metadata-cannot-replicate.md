---
name: moc-construction-forces-synthesis-that-automated-generation-from-metadata-cannot-replicate
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/MOC construction forces synthesis that automated generation from metadata cannot replicate.md
