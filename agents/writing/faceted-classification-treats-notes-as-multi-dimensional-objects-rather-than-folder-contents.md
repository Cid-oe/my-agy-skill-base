---
name: faceted-classification-treats-notes-as-multi-dimensional-objects-rather-than-folder-contents
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/faceted classification treats notes as multi-dimensional objects rather than folder contents.md
