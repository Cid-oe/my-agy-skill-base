---
name: m2close-zekqgl-reviewer-1
description: 'Documentation-only change: 162 insertions to `README_zh.md` translating m2 feature sections that were present in the English README but missing from the Chinese translation.'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: PeonPing/peon-ping
    ...
    path: .gitban/agents/reviewer/inbox/M2CLOSE-zekqgl-reviewer-1.md
