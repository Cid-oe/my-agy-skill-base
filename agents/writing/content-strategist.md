...
agy:
  ...
  - repo: nuttaruj/rolepod
    ...
    path: plugins/rolepod-cursor/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: core/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: claude/src/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: plugins/maestro/src/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: src/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: rohitg00/awesome-claude-code-toolkit
    author: rohitg00
    license: Apache-2.0
    url: https://github.com/rohitg00/awesome-claude-code-toolkit
    path: agents/business-product/content-strategist.md
    format: markdown-frontmatter
  - repo: alirezarezvani/claude-skills
    author: alirezarezvani
    license: MIT
    url: https://github.com/alirezarezvani/claude-skills
    path: agents/personas/content-strategist.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: agents/content_strategist.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: claude/agents/content-strategist.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: qwen/agents/content_strategist.md
    format: markdown-frontmatter
---
