...
agy:
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    path: plugins/content-creator/agents/content-creator.md
  ...
  - repo: jnMetaCode/agency-orchestrator
    ...
    path: agency-agents/marketing/marketing-content-creator.md
    format: markdown-frontmatter
  ...
  - repo: fatihkan/badi
    ...
    path: .claude/agents/content-creator.md
    format: markdown-frontmatter
---
