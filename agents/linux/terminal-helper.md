...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''execute/getTerminalOutput'', ''execute/runInTerminal'', ''read/terminalLastCommand'', ''read/terminalSelection''].'
  validation: passed
  ...
  - repo: github/awesome-copilot
    ...
    path: agents/terminal-helper.agent.md
