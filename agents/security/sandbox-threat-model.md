---
name: sandbox-threat-model
description: What the tool sandbox does and does **not** contain, per platform, and where the
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: JuliusBrussee/caveman
    ...
    path: packages/agent/SANDBOX_THREAT_MODEL.md
