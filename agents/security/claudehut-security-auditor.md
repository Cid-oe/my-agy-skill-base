...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: postgres, mysql, kafka.'
  validation: passed
  imported: '2026-08-26T09:13:17+00:00'
  sources:
  - repo: taipt1504/claudehut
    author: taipt1504
    license: NOASSERTION
    url: https://github.com/taipt1504/claudehut
    path: agents/claudehut-security-auditor.md
