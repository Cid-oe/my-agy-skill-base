...
agy:
  ...
  compatibility:
    ...
    score: 100
    notes: Converted directly; no manual steps required. Merged 10 same-name variants into one canonical agent.
  validation: passed
  ...
  - repo: jnMetaCode/agency-orchestrator
    ...
    path: agency-agents/engineering/engineering-security-engineer.md
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/03-infrastructure/security-engineer.md
    format: markdown-frontmatter
  ...
  - repo: josstei/maestro-orchestrate
    ...
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: qwen/agents/security_engineer.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: claude/src/agents/security-engineer.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: plugins/maestro/src/agents/security-engineer.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: src/agents/security-engineer.md
    format: markdown-frontmatter
  ...
  - repo: nuttaruj/rolepod
    ...
    path: core/agents/security-engineer.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod-cursor/agents/security-engineer.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/security-engineer.md
    format: markdown-frontmatter
---
