...
agy:
  ...
  - repo: VKirill/codex-starter-kit
    ...
    path: agents/engineering_threat_detection_engineer.toml
    format: toml
---
...
Use `/codex-adversarial` to pressure-test your design after detection-rule or coverage proposal. Codex (GPT-5) in adversarial mode challenges assumptions, tradeoffs, and alternative approaches — exactly the angles a single architect can miss.
