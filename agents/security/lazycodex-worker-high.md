...
agy:
  ...
  - repo: code-yeongyu/oh-my-openagent
    ...
    path: packages/omo-codex/plugin/components/ultrawork/agents/lazycodex-worker-high.toml
    format: toml
  - repo: code-yeongyu/oh-my-openagent
    author: code-yeongyu
    license: NOASSERTION
    url: https://github.com/code-yeongyu/oh-my-openagent
    path: packages/omo-codex/plugin/components/ultrawork/agents/lazycodex-worker-low.toml
    format: toml
  - repo: code-yeongyu/oh-my-openagent
    author: code-yeongyu
    license: NOASSERTION
    url: https://github.com/code-yeongyu/oh-my-openagent
    path: packages/omo-codex/plugin/components/ultrawork/agents/lazycodex-worker-medium.toml
    format: toml
---
