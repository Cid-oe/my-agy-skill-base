...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: #, needed, for, report/data, file, output. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  imported: '2026-08-26T08:59:41+00:00'
  sources:
  ...
  - repo: fusengine/agents
    ...
    path: plugins/seo/agents/seo-technical.md
    format: markdown-frontmatter
---
