---
name: collective-intelligence-coordinator-security
...
agy:
  ...
  - repo: ruvnet/ruflo
    ...
    path: v3/@claude-flow/cli/.claude/agents/v3/collective-intelligence-coordinator.md
    format: markdown-frontmatter
  - repo: ruvnet/ruflo
    author: ruvnet
    license: MIT
    url: https://github.com/ruvnet/ruflo
    path: v3/@claude-flow/mcp/.claude/agents/v3/collective-intelligence-coordinator.md
    format: markdown-frontmatter
---
