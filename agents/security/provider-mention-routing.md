---
name: provider-mention-routing
description: '{{if or (eq .Provider "claude") (eq .Provider "claude-code")}}'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: tutti-os/tutti
    ...
    path: packages/agent/runtimeprep/policy_templates/provider-mention-routing.md
