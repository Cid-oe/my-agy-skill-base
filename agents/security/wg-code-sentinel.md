...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''changes'', ''codebase'', ''edit/editFiles'', ''extensions'', ''web/fetch'', ''findTestFiles'', ''githubRepo'', ''new'', ''openSimpleBrowser'', ''problems'', ''runCommands'', ''runNotebooks'', ''runTasks'', ''search'', ''searchResults'', ''terminalLastCommand'', ''terminalSelection'', ''testFailure'', ''usages'', ''vscodeAPI''].'
  validation: passed
