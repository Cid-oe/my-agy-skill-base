...
agy:
  ...
  compatibility:
    ...
    score: 100
    notes: Converted directly; no manual steps required. Merged 21 same-name variants into one canonical agent.
  validation: passed
  ...
  - repo: jnMetaCode/agency-orchestrator
    ...
    path: agency-agents/engineering/engineering-code-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: shanraisshan/claude-code-best-practice
    ...
    path: development-workflows/rpi/.claude/agents/code-reviewer.md
    format: markdown-frontmatter
  - repo: affaan-m/ECC
    author: affaan-m
    license: MIT
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/04-quality-security/code-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    license: Apache-2.0
    url: https://github.com/ccplugins/awesome-claude-code-plugins
    path: plugins/code-reviewer/agents/code-reviewer.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/wshobson/code-reviewer.md
    format: markdown-frontmatter
  - repo: rohitg00/awesome-claude-code-toolkit
    author: rohitg00
    license: Apache-2.0
    url: https://github.com/rohitg00/awesome-claude-code-toolkit
    path: agents/quality-assurance/code-reviewer.md
    format: markdown-frontmatter
  - repo: kubb-labs/kubb
    author: kubb-labs
    license: MIT
  ...
  - repo: ccplugins/awesome-claude-code-plugins
    ...
    license: Apache-2.0
    url: https://github.com/ccplugins/awesome-claude-code-plugins
    path: plugins/slicewise/agents/code-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: josstei/maestro-orchestrate
    ...
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: qwen/agents/code_reviewer.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: claude/src/agents/code-reviewer.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: plugins/maestro/src/agents/code-reviewer.md
    format: markdown-frontmatter
  - repo: josstei/maestro-orchestrate
    author: josstei
    license: Apache-2.0
    url: https://github.com/josstei/maestro-orchestrate
    path: src/agents/code-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: leamas-ai/leamas.sh
    ...
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/awesome-claude-agents/agents/core/code-reviewer.md
    format: markdown-frontmatter
  - repo: CodeDraig/codex-subagents
    author: CodeDraig
    license: ''
    url: https://github.com/CodeDraig/codex-subagents
    path: AGENTS/openai/code-reviewer.toml
    format: toml
