---
name: gates
description: 'This is the authoritative roadmap-first gate contract. New runs are useful-first: store the mission once, approve one executable roadmap, dispatch implementation-ready lanes directly, and verify independently. There is no separate intake round trip and no mandatory preflight agent.'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  compatibility:
    ...
    score: 50
    notes: No frontmatter/metadata detected; prompt extracted from raw text. Merged 8 same-name variants into one canonical agent.
  validation: passed
  ...
  - repo: Spielewoy/autoprompt-skill
    ...
    path: agents/claude/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/codex/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/deepseek/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/kilo/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/omp/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/opencode/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/reasonix/GATES.md
    format: markdown-frontmatter
  - repo: Spielewoy/autoprompt-skill
    author: Spielewoy
    license: MIT
    url: https://github.com/Spielewoy/autoprompt-skill
    path: agents/vscode/GATES.md
    format: markdown-frontmatter
---
