...
agy:
  ...
  compatibility:
    ...
    score: 100
    notes: Converted directly; no manual steps required. Merged 17 same-name variants into one canonical agent.
  validation: passed
  imported: '2026-08-26T09:12:00+00:00'
  sources:
  ...
  - repo: eugenelim/agent-ready-repo
    ...
    license: Apache-2.0
    url: https://github.com/eugenelim/agent-ready-repo
    path: packs/core/.apm/agents/security-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: shinpr/claude-code-workflows
    ...
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-frontend/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows-fullstack/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: shinpr/claude-code-workflows
    author: shinpr
    license: MIT
    url: https://github.com/shinpr/claude-code-workflows
    path: dev-workflows/agents/security-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: can1357/oh-my-pi
    ...
    path: packages/coding-agent/src/prompts/agents/security-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: luongnv89/claude-howto
    ...
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: ja/07-plugins/pr-review/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: uk/07-plugins/pr-review/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: vi/07-plugins/pr-review/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: zh/07-plugins/pr-review/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    author: jeremylongshore
    license: MIT
    url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills
    path: plugins/ai-agency/hyperflow/agents/security-reviewer.md
    format: markdown-frontmatter
  ...
  - repo: ezBuilder/code-brain
    ...
    path: kits/global-agent-kit/.claude/agents/security-reviewer.md
    format: markdown-frontmatter
  - repo: Forcharc/claude-config-shared
    author: Forcharc
    license: ''
    url: https://github.com/Forcharc/claude-config-shared
    path: agents/security-reviewer.md
    format: markdown-frontmatter
