...
agy:
  ...
  compatibility:
    status: requires-mcp
    score: 85
    notes: 'Requires MCP servers: basic-memory, zen. Merged 2 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: avivl/claude-007-agents
    ...
    path: .claude/agents/security/security-specialist.md
    format: markdown-frontmatter
  - repo: senaiverse/reactnative-expo-ai-agent-system-workflow
    author: senaiverse
    license: MIT
    url: https://github.com/senaiverse/reactnative-expo-ai-agent-system-workflow
    path: ready-to-use/agents/tier-2-power/security-specialist.md
    format: markdown-frontmatter
---
