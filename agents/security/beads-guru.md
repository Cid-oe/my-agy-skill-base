...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Bash(bd, list:*), Bash(bd, show:*), Bash(bd, ready:*), Bash(bd, memories:*), Bash(bd, search:*), Bash(bd, stats:*), Bash(bd-sync, status:*), Bash(git, status:*), Bash(git, log:*).'
  validation: passed
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/mcp/dolt-mcp-vcs/agents/beads-guru.md
