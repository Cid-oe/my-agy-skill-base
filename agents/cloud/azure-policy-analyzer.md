...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [read, search, execute, web, azure-mcp/*, ms-azuretools.vscode-azure-github-copilot/azure_query_azure_resource_graph].'
  validation: passed
  ...
  - repo: github/awesome-copilot
    ...
    path: agents/azure-policy-analyzer.agent.md
