...
agy:
  ...
  - repo: nuttaruj/rolepod
    ...
    path: plugins/rolepod-cursor/agents/data-scientist.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: plugins/rolepod/agents/data-scientist.md
    format: markdown-frontmatter
  - repo: nuttaruj/rolepod
    author: nuttaruj
    license: MIT
    url: https://github.com/nuttaruj/rolepod
    path: core/agents/data-scientist.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: ja/04-subagents/data-scientist.md
    format: markdown-frontmatter
---
