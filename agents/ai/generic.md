---
name: generic
description: Autoprompt is an explicit-only, useful-first orchestration loop. It stores the exact mission once, produces one executable roadmap, builds dependency-safe lanes, and independently verifies completion.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Spielewoy/autoprompt-skill
    ...
    path: agents/contracts/generic.md
