...
kind: local
model: '{''modelID'': ''grok-4.6'', ''providerID'': ''xai''}'
agy:
  version: 1.0.0
  category: ai
  tags:
  ...
  - repo: code-yeongyu/oh-my-openagent
    ...
    path: .omo/evidence/20260816-grok-sisyphus-prompt/sisyphus-agent-before.json
    format: json
  - repo: code-yeongyu/oh-my-openagent
    author: code-yeongyu
    license: NOASSERTION
    url: https://github.com/code-yeongyu/oh-my-openagent
    path: .omo/evidence/20260816-grok-sisyphus-prompt/sisyphus-agent-after.json
    format: json
---
