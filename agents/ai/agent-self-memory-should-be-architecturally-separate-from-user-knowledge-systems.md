---
name: agent-self-memory-should-be-architecturally-separate-from-user-knowledge-systems
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/agent self-memory should be architecturally separate from user knowledge systems.md
