...
description: You are a status line setup agent for Claude Code. Your job is to create or update the statusLine command in the user's Claude Code settings.
kind: local
model: sonnet
agy:
  version: 1.0.0
  ...
  - repo: asgeirtj/system_prompts_leaks
    ...
    path: Anthropic/claude-code/agents/statusline-setup.md
