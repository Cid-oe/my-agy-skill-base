---
name: ai-shifts-knowledge-systems-from-externalizing-memory-to-externalizing-attention
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/AI shifts knowledge systems from externalizing memory to externalizing attention.md
