---
name: agent-system
description: Agents are markdown files with YAML frontmatter and a system prompt body.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/agent-system.md
