---
name: chat-storage-design
description: This document describes the design for storing chat conversations, messages, and execution steps in the YAO Agent system.
kind: local
model: inherit
agy:
  version: 1.0.0
