...
description: You are a reproduce-issue agent responsible for reproducing bugs reported in GitHub issues in the OpenChamber repository.
kind: local
...
agy:
  ...
  - repo: openchamber/openchamber
    ...
    path: .opencode/agent/reproduce-issue.md
