---
name: schema-enforcement-via-validation-agents-enables-soft-consistency
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/schema enforcement via validation agents enables soft consistency.md
