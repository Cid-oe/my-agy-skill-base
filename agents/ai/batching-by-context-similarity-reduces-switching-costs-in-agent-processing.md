---
name: batching-by-context-similarity-reduces-switching-costs-in-agent-processing
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/batching by context similarity reduces switching costs in agent processing.md
