---
name: clean-code-reviewer-ai
description: '<!-- i18n-source: 04-subagents/clean-code-reviewer.md -->'
kind: local
model: inherit
tools:
- read_file
...
agy:
  ...
  - repo: luongnv89/claude-howto
    ...
    path: ja/04-subagents/clean-code-reviewer.md
    format: markdown-frontmatter
  - repo: luongnv89/claude-howto
    author: luongnv89
    license: MIT
    url: https://github.com/luongnv89/claude-howto
    path: zh/04-subagents/clean-code-reviewer.md
    format: markdown-frontmatter
---
