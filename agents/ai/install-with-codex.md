---
name: install-with-codex
description: Copy the prompt below into Codex. It installs a personal custom subagent, its
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: Utopia-V/mixagents
    ...
    path: packages/codex-deepseek-subagent/prompts/install-with-codex.md
