---
name: asset-import
description: 把本机 Hermes Agent 的 **skill / session** 导入 Memory Hub。这一份手册即可完成。
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  compatibility:
    ...
    score: 50
    notes: No frontmatter/metadata detected; prompt extracted from raw text. Merged 7 same-name variants into one canonical agent.
  validation: passed
  imported: '2026-08-26T08:59:28+00:00'
  sources:
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/hermes/asset-import.md
    format: markdown-frontmatter
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/dsh/asset-import.md
    format: markdown-frontmatter
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/claude-code/asset-import.md
    format: markdown-frontmatter
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/codebuddy/asset-import.md
    format: markdown-frontmatter
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/codex/asset-import.md
    format: markdown-frontmatter
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/openclaw/asset-import.md
    format: markdown-frontmatter
  - repo: TencentCloud/TencentDB-Agent-Memory
    author: TencentCloud
    license: NOASSERTION
    url: https://github.com/TencentCloud/TencentDB-Agent-Memory
    path: agents/workbuddy/asset-import.md
    format: markdown-frontmatter
---
