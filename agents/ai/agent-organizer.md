...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Task. Merged 6 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: leamas-ai/leamas.sh
    ...
    path: kits/agents/claude-code-sub-agents/agent-organizer.md
    format: markdown-frontmatter
  - repo: lst97/claude-code-sub-agents
    author: lst97
    license: MIT
    url: https://github.com/lst97/claude-code-sub-agents
    path: agents/agent-organizer.md
    format: markdown-frontmatter
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/09-meta-orchestration/agent-organizer.md
    format: markdown-frontmatter
