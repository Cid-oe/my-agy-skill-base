...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: [''read'', ''edit'', ''search'', ''shell'', ''neo4j-local/neo4j-local-get_neo4j_schema'', ''neo4j-local/neo4j-local-read_neo4j_cypher'', ''neo4j-local/neo4j-local-write_neo4j_cypher''].'
  validation: passed
