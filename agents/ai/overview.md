---
name: overview
description: Sprout is a TypeScript/Bun multi-agent runtime. A root orchestrator receives a
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/overview.md
