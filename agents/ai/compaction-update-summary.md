---
name: compaction-update-summary
description: Update existing handoff summary in <previous-summary> tags from new messages above for another LLM to resume.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: can1357/oh-my-pi
    ...
    path: packages/agent/src/compaction/prompts/compaction-update-summary.md
