---
name: temporal-media-must-convert-to-spatial-text-for-agent-traversal
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/temporal media must convert to spatial text for agent traversal.md
