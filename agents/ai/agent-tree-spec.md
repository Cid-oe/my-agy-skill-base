---
name: agent-tree-spec
description: Reference for creating and managing agents in the sprout agent tree.
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/agent-tree-spec.md
