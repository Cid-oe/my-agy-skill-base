---
name: three-capture-schools-converge-through-agent-mediated-synthesis
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/three capture schools converge through agent-mediated synthesis.md
