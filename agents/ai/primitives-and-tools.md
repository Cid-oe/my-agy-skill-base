---
name: primitives-and-tools
description: 'Sprout exposes capabilities to agents as LLM tools. There are two families:'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/primitives-and-tools.md
