---
name: learn-process
description: The learn process turns agent stumbles into durable improvements. It has two
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/learn-process.md
