---
name: trails-transform-ephemeral-navigation-into-persistent-artifacts
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/trails transform ephemeral navigation into persistent artifacts.md
