---
name: agent-session-boundaries-create-natural-automation-checkpoints-that-human-operated-systems-lack
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/agent session boundaries create natural automation checkpoints that human-operated systems lack.md
