---
name: goal-driven-memory-orchestration-enables-autonomous-domain-learning-through-directed-compute-allocation
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/goal-driven memory orchestration enables autonomous domain learning through directed compute allocation.md
