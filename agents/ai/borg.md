...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: Task, Skill.'
  validation: passed
  imported: '2026-08-26T09:11:32+00:00'
  sources:
  - repo: aplaceforallmystuff/claude-agent-borg
    author: aplaceforallmystuff
    license: MIT
    url: https://github.com/aplaceforallmystuff/claude-agent-borg
    path: agents/borg.md
