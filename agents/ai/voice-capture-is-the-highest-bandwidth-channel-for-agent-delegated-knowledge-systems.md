---
name: voice-capture-is-the-highest-bandwidth-channel-for-agent-delegated-knowledge-systems
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/voice capture is the highest-bandwidth channel for agent-delegated knowledge systems.md
