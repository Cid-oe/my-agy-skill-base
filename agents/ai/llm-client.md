---
name: llm-client
description: Sprout uses a provider registry and native provider adapters. The runtime
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/llm-client.md
