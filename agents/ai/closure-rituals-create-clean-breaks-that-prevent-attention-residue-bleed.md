---
name: closure-rituals-create-clean-breaks-that-prevent-attention-residue-bleed
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/closure rituals create clean breaks that prevent attention residue bleed.md
