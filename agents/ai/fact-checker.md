...
agy:
  ...
  - repo: dongbeixiaohuo/writing-agent
    ...
    path: plugins/writing-agent/agents/fact-checker.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: claude-runtime/agents/fact-checker.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/scripts/generate_clean.py" --stdout articles/[项目名]/[最终正文文件] > temp/fact_check_body.txt
