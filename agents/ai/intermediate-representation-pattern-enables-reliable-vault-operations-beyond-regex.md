---
name: intermediate-representation-pattern-enables-reliable-vault-operations-beyond-regex
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/intermediate representation pattern enables reliable vault operations beyond regex.md
