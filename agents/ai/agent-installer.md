...
agy:
  ...
  compatibility:
    ...
    score: 75
    notes: 'Unmapped tools: ["Read", "Write", "Edit", "Bash", "Glob", "Grep"]. Merged 5 same-name variants into one canonical agent.'
  validation: passed
  ...
  - repo: rohitg00/awesome-claude-code-toolkit
    ...
    path: agents/orchestration/agent-installer.md
  ...
  - repo: ayush-that/sub-agents.directory
    ...
    path: content/09-meta-orchestration/agent-installer.md
    format: markdown-frontmatter
