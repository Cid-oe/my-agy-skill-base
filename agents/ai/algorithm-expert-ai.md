---
name: algorithm-expert-ai
description: You are an expert in reinforcement learning algorithms for LLM training, specializing in
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: areal-project/AReaL
    ...
    path: .codex/agents/algorithm-expert.md
