...
agy:
  ...
  - repo: dongbeixiaohuo/writing-agent
    ...
    path: .claude/agents/position-engine.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: claude-runtime/agents/position-engine.md
    format: markdown-frontmatter
  - repo: dongbeixiaohuo/writing-agent
    author: dongbeixiaohuo
    license: MIT
    url: https://github.com/dongbeixiaohuo/writing-agent
    path: plugins/writing-agent/agents/position-engine.md
    format: markdown-frontmatter
---
...
然后检查 `01_theme.md` 中的「写作风格」。如果指定了风格，**必须**读取风格文件的 `00. 风格内核` 一节：
