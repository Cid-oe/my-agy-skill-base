---
name: genome
description: The genome is Sprout's git-backed runtime state. It stores agent overlays,
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: prime-radiant-inc/sprout
    ...
    path: root/agents/quartermaster/resources/sprout-architecture/genome.md
