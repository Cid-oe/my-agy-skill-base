---
name: platform-fragmentation-means-identical-conceptual-operations-require-different-implementations-across-agent-environments
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/platform fragmentation means identical conceptual operations require different implementations across agent environments.md
