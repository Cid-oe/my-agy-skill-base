---
name: mail-triage
description: '- Whenever a new email wakes the agent, read this file in full and match the email against the “Matching Criteria” from top to bottom.'
kind: local
model: inherit
agy:
  version: 1.0.0
  ...
  - repo: agentscope-ai/QwenPaw
    ...
    path: src/qwenpaw/agents/md_files/id/MAIL_TRIAGE.md
    format: markdown-frontmatter
  - repo: agentscope-ai/QwenPaw
    author: agentscope-ai
    license: Apache-2.0
    url: https://github.com/agentscope-ai/QwenPaw
    path: src/qwenpaw/agents/md_files/ru/MAIL_TRIAGE.md
    format: markdown-frontmatter
  - repo: agentscope-ai/QwenPaw
    author: agentscope-ai
    license: Apache-2.0
    url: https://github.com/agentscope-ai/QwenPaw
    path: src/qwenpaw/agents/md_files/en/MAIL_TRIAGE.md
    format: markdown-frontmatter
---
