---
name: good-descriptions-layer-heuristic-then-mechanism-then-implication
...
agy:
  ...
  category: ai
  tags:
  - good descriptions layer heuristic then mechanism then implication
  compatibility:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/good descriptions layer heuristic then mechanism then implication.md
