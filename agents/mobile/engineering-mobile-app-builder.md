...
agy:
  ...
  category: mobile
  tags:
  - engineering_mobile_app_builder
  compatibility:
  ...
  - repo: VKirill/codex-starter-kit
    ...
    path: agents/engineering_mobile_app_builder.toml
    format: toml
---
...
### MCP / Tool Routing
- Use Context7/official docs for current mobile framework APIs.
- Use Serena for repository navigation and code edits.
- Use GitNexus when mobile changes affect shared backend/API contracts.
- Use browser/UI evidence tools only when validating cross-platform web surfaces.

### Skill Routing
- Prefer flutter-expert, react-native-architecture, expo skills, frontend/testing patterns, and Superpowers verification skills as relevant.
- Avoid database/devops/backend-heavy skills unless the mobile task explicitly spans those systems.
</CODEx-TOOLING-SKILL-ROUTING>
