---
name: product-management-uses-feedback-pipelines-with-experiment-tracking
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/product management uses feedback pipelines with experiment tracking.md
