---
name: enforce-schema-with-graduated-strictness-across-capture-processing-and-query-zones
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/enforce schema with graduated strictness across capture processing and query zones.md
