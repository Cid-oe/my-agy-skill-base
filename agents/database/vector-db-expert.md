...
agy:
  ...
  - repo: jeremylongshore/claude-code-plugins-plus-skills
    ...
    path: plugins/packages/ai-ml-engineering-pack/plugins/03-rag-systems/agents/vector-db-expert.md
    format: markdown-frontmatter
  - repo: 0xfurai/claude-code-subagents
    author: 0xfurai
    license: MIT
    url: https://github.com/0xfurai/claude-code-subagents
    path: agents/vector-db-expert.md
    format: markdown-frontmatter
  - repo: leamas-ai/leamas.sh
    author: leamas-ai
    license: MIT
    url: https://github.com/leamas-ai/leamas.sh
    path: kits/agents/claude-code-subagents/agents/vector-db-expert.md
    format: markdown-frontmatter
---
