---
name: multi-domain-systems-compose-through-separate-templates-and-shared-graph
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/multi-domain systems compose through separate templates and shared graph.md
