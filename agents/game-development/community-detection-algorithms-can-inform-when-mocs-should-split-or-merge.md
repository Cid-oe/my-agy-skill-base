---
name: community-detection-algorithms-can-inform-when-mocs-should-split-or-merge
...
agy:
  ...
  - repo: agenticnotetaking/arscontexta
    ...
    path: methodology/community detection algorithms can inform when MOCs should split or merge.md
